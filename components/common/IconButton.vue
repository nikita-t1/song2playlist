...
<template>
    <div class="mx-1 hs-tooltip inline-block [--placement:bottom]">
        <button class="bg-green-500 hs-tooltip-toggle rounded w-10 h-10 flex justify-center items-center hover:bg-green-600"
                @click="action">
            <Icon :name="name" :size="size" class="text-white"/>
            <span
